...
{   
    ...
    //once
    auto main_component = ftxui::CatchEvent(ftxui::Container::Vertical({
    ...
    app.add_on_state_change_event([this, menu_component](Application::State old_state, Application::State new_state){
        switch(new_state){
